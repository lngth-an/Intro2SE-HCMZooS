...
const StudentNotifications = () => {
  ...
  const sendMail = (notification) => {
    const mailto = `mailto:${
      notification.senderEmail || "example@domain.com"
    }?subject=Phản hồi thông báo: ${encodeURIComponent(
            ...
            {[...notifications]
              ...
              .map((notification) => (
                <div
                  ...
                  className={`w-full rounded-lg shadow-md p-5 transition duration-300 flex flex-col ${
