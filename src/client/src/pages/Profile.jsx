          ...
          <div className="bg-white shadow rounded-2xl p-6 mb-8 mt-6">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="flex gap-4">
                <button type="submit" className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700" disabled={loading}>
                  {loading ? 'Đang lưu...' : 'Lưu thay đổi'}
                </button>
                <button type="button" className="text-sm underline" onClick={() => setForm({ ...form, email: profile.email, phone: profile.phone })}>
                  Hủy thay đổi
                </button>
              </div>
          ...
          <div className="bg-white shadow rounded-2xl p-6">
            ...
            {!pwMode ? (
              ...
              <form onSubmit={handlePwSubmit} className="space-y-4 mt-4">
                ...
                <div className="flex gap-4">
                  <button type="submit" className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700" disabled={pwLoading}>
